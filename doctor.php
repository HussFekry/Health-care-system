...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE doctor SET doctorname='$_POST[doctorname]',mobileno='$_POST[mobilenumber]',departmentid='$_POST[departmentid]',loginid='$_POST[loginid]', password='$_POST[password]',status='$_POST[status]',education='$_POST[education]',experience='$_POST[experience]', WHERE doctorid='$_GET[editid]'";
...
<?php
    ...
    else
    {
        ...
        #$sql ="INSERT INTO doctor(doctorname,mobileno,departmentid,loginid,password,status,education,experience) values('$_POST[doctorname]','$_POST[mobileno]','$_POST[departmentid]','$_POST[loginid]','$pass','$_POST[status]','$_POST[education]','$_POST[experience]')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
